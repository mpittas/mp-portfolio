...
class Simulation extends React.Component {
  ...
  componentDidMount() {
    ...
    var shape7 = Bodies.circle(10, 595, 20, {
      render: {fillStyle: "#7C3A2E"},
    })

    var shape8 = Bodies.rectangle(100, 595, 100, 100, {
      render: {fillStyle: "#C25822"},
    })
    var shape9 = Bodies.circle(200, 595, 40, {
      render: {fillStyle: "#7C3A2E"},
    })
    var shape10 = Bodies.rectangle(280, 500, 80, 80, {
      render: {fillStyle: "#ECD7C9"},
    })
    var shape11 = Bodies.rectangle(340, 595, 40, 40, {
      render: {fillStyle: "#7C3A2E"},
    })
    var shape12 = Bodies.circle(360, 595, 30, {
      render: {fillStyle: "#C25822"},
    })
    var shape13 = Bodies.circle(10, 595, 20, {
      render: {fillStyle: "#7C3A2E"},
    })

    var shape14 = Bodies.rectangle(100, 595, 100, 100, {
      render: {fillStyle: "#C25822"},
    })
    var shape15 = Bodies.circle(200, 595, 40, {
      render: {fillStyle: "#7C3A2E"},
    })
    var shape16 = Bodies.rectangle(280, 500, 80, 80, {
      render: {fillStyle: "#ECD7C9"},
    })
    var shape17 = Bodies.rectangle(340, 595, 40, 40, {
      render: {fillStyle: "#7C3A2E"},
    })
    var shape18 = Bodies.circle(360, 595, 30, {
      render: {fillStyle: "#C25822"},
    })
    var shape19 = Bodies.circle(200, 595, 40, {
      render: {fillStyle: "#7C3A2E"},
    })
    var shape20 = Bodies.rectangle(280, 500, 80, 80, {
      render: {fillStyle: "#ECD7C9"},
    })
    var shape21 = Bodies.rectangle(340, 595, 40, 40, {
      render: {fillStyle: "#7C3A2E"},
    })
    var shape22 = Bodies.circle(360, 595, 30, {
      render: {fillStyle: "#C25822"},
    })
